...
import { ChevronLeft, ChevronRight, Award, Users, MapPin, BookOpen, Wrench, Building, Code, TrendingUp, Clock, CheckCircle } from 'lucide-react';
...
const HeroOptions = () => {
  ...
  const courses = [
    { name: 'AutoCAD Civil', duration: '3 Months', icon: Building, mode: 'Online/Offline' },
    { name: 'AutoCAD Mechanical', duration: '3 Months', icon: Wrench, mode: 'Online/Offline' },
    { name: 'Revit Architecture', duration: '2 Months', icon: Building, mode: 'Online/Offline' },
    { name: 'Digital Marketing', duration: '4 Months', icon: TrendingUp, mode: 'Online/Offline' },
    { name: 'Full Stack Development', duration: '6 Months', icon: Code, mode: 'Online/Offline' },
    { name: 'STAAD Pro', duration: '2 Months', icon: Building, mode: 'Offline' }
  ];
  ...
  const nextImageSlide = () => setImageSlide((prev) => (prev + 1) % heroImages.length);
  const prevImageSlide = () => setImageSlide((prev) => (prev - 1 + heroImages.length) % heroImages.length);
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8">
                Join 10,000+ successful students across 20+ locations. Expert-led training with 100% placement support.
              </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mt-4">
                <div className="space-y-4">
                  <div className="flex items-center text-blue-700">
                    ...
                    <span className="font-medium">Live Interactive Sessions</span>
                  </div>
                  <div className="flex items-center text-blue-700">
                    <CheckCircle className="w-5 h-5 mr-3 text-yellow-500" />
                    <span className="font-medium">Industry Expert Trainers</span>
                  </div>
                  <div className="flex items-center text-blue-700">
                    <CheckCircle className="w-5 h-5 mr-3 text-yellow-500" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {courses.slice(0, 3).map((course, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition transform hover:-translate-y-1">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <h1 className="text-6xl font-bold mb-6 leading-tight">
              Master CAD & IT Skills That<br />Companies Actually Need
            </h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              20+ years of excellence in technical training. From AutoCAD to Full Stack Development, we've got you covered.
            </p>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                Build Your Future with<br />Expert Technical Training
              </h1>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                From CAD design to digital marketing, learn job-ready skills from industry experts at India's premier training institute.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-10">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {courses.slice(0, 3).map((course, idx) => (
                <div key={idx} className="border-2 border-gray-200 rounded-xl p-6 hover:border-yellow-400 hover:shadow-lg transition group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {courses.map((course, idx) => (
              <div key={idx} className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">{course.name}</h3>
                <div className="text-gray-600 text-sm mb-4">{course.duration} • {course.mode}</div>
